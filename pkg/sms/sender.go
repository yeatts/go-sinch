...
func (s *batchSender) FromRequest(req *SendRequest) SMSBatchSender {
	s.request = req
	return s
}

// WithBody sets the message body for the request.
func (s *batchSender) WithBody(body string) SMSBatchSender {
	s.request.Body = body
	return s
}

// WithDeliveryReport sets the delivery report option for the request.
func (s *batchSender) WithDeliveryReport(deliveryReport DeliveryReport) SMSBatchSender {
	s.request.DeliveryReport = deliveryReport
	return s
}

// To sets the recipient(s) for the request.
func (s *batchSender) To(to ...string) SMSBatchSender {
	s.request.ToNumbers = append(s.request.ToNumbers, to...)
	return s
}

// From sets the sending number for the request.
func (s *batchSender) From(from string) SMSBatchSender {
	s.request.FromNumber = from
	return s
}

// WithParameters sets the provided parameters for the request.
func (s *batchSender) WithParameters(parameters map[string]map[string]string) SMSBatchSender {
...
func (s *batchSender) WithTruncateConcatEnabled() SMSBatchSender {
	s.request.TruncateConcat = true
	return s
}

// WithMaxNumberOfMessageParts sets the maximum number of message parts for the request.
func (s *batchSender) WithMaxNumberOfMessageParts(maxNumberOfMessageParts int) SMSBatchSender {
...
func (s *batchSender) WithTonOverride(fromTypeOfNumber int) SMSBatchSender {
...
func (s *batchSender) WithNPIOverride(fromNumberPlanIndicator int) SMSBatchSender {
...
func (s *batchSender) Send() SMSBatchSender {
...
func (s *batchSender) Request() *SendRequest {
	return s.request
}
...
func (s *batchSender) Response() *SendResponse {
	return s.response
}
